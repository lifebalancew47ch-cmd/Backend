...
public class PushController : ControllerBase
{
    ...
    [HttpPost("company")]
    public async Task<IActionResult> SendToCompany([FromBody] BroadcastPushDto dto)
    {
    ...
    [HttpPost("family")]
    public async Task<IActionResult> SendToFamily([FromBody] BroadcastPushDto dto)
    {
        dto.FamilyId = dto.FamilyId;
        var result = await _pushService.BroadcastAsync(dto);
        return Ok(new Response<List<NotificationResponseDto>>(result));
    }

    [HttpPost("department")]
    public async Task<IActionResult> SendToDepartment([FromBody] BroadcastPushDto dto)
    {
