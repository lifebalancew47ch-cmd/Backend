...
{
    /// <summary>
    /// Maps liveness, readiness, and full health check endpoints.
    /// </summary>
    public static IEndpointRouteBuilder MapReportingHealthChecks(this IEndpointRouteBuilder endpoints)
    {
